...
// import msg from '../../../../assets/images/message-circle.svg';
    ...
    render() {
        ...
        let navContent = (
            <div className="navbar-wrapper">
                ...
                <div className="w-100" style={{backgroundColor:'#4f4c63',height:'7rem',position:'absolute', bottom:'10px'}}>
                    <div style={{fontSize:'3rem'}} className="w-100 text-center"><img src={chat} width={'25%'}></img></div>
                    {/* <h4 className="text-center text-white pb-5" >Chat</h4> */}
                </div>
            </div>
        );
