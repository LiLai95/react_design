...
class NavContent extends Component {
    ...
    render() {
        ...
        if (this.props.layout === 'horizontal') {
            ...
            mainContent = (
                <div className="navbar-content sidenav-horizontal" id="layout-sidenav" style={{backgroundColor:'#404152'}}>
            ...
            mainContent = (
                <div className="navbar-content datta-scroll" style={{backgroundColor:'#404152', paddingBottom:'7rem'}}>
                    <PerfectScrollbar>
