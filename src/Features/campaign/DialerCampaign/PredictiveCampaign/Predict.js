        ...
        return (
            <Aux>
                <div className="mt-5 text-center">
                    ...
                    <button className="btn_drip pl-5 pr-5 pt-1 pb-1"><NavLink to={'/Campaign/DialerCampaign/Progressivecampaign/Wireframe'}>PROGRESSIVE</NavLink></button><br></br>
                    <button className="btn_blast_selected mt-3 pl-5 pr-5 pt-1 pb-1"><NavLink to={'/Campaign/DialerCampaign/PredictiveCampaign/Wireframe'}>PREDICTIVE</NavLink></button>    
                </div>
                        ...
                        <Col sm={6} md={6} lg={6}>
                            ...
                            <Row className="mt-4">
                                ...
                                <Col sm={6} md={6} lg={6}>
                                    ...
                                    <div className="mt-3">
                                        <Slider className="pc-range-slider" min={0} max={100} marks={{45: 45, 0:0, 100: 100 }} included={false} defaultValue={45} handle={handle} />
                                    </div>
