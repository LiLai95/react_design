            ...
            <Aux>
                ...
                <div className="main_frame mt-3 ml-4">
                    <Row className="w-100">
                        ...
                        <Col sm={6} md={6} lg={4} className="frame-center mt-2 mb-2">
                            <Row>
                                <Col lg={4}></Col>
                                <Col lg={3}>
                                    <div className="mt-5">
                                    ...
                                    <div style={{height:'5rem',width:'7rem'}} className="ml-2 mt-2">
                                        <Col style={{borderRightStyle:'solid', borderRightColor:'black', borderRightWidth:'1px', height:'100%'}} lg={6}></Col>
                                    </div>
                                    <Row>
                                        <div>
                                            <ButtonToolbar>
                                                {[ 'right'].map(placement => (
                                                    ...
                                                    >
                                                    <Button className="btn_circle pl-5 pr-5 ml-3" variant="light">DELAY<br></br>7 DAYS<br></br>7 HOURS<br></br>55 MIN</Button>
                                                    </OverlayTrigger>
                                                ))}
                                            </ButtonToolbar>
                                        </div>
                                    </Row>
                                    <div style={{height:'5rem',width:'7rem'}} className="ml-2">
                                        <Col style={{borderRightStyle:'solid', borderRightColor:'black', borderRightWidth:'1px', height:'100%'}} lg={6}></Col>
                                    </div>
                                    <div className="ml-3">
                                        <ButtonToolbar>
                                                ...
                                                overlay={
                                                    ...
                                                    <div className="p-1">
                                                            <Row>
                                                                ...
                                                                <Col lg={4}>
                                                                    <Button className="btn_pop" variant="light">DELEVERED</Button>
                                                                    <Button className="btn_pop" variant="light">FAILED</Button>
                                                                </Col>
                                                                <Col lg={4}>
                                                                    <Button className="btn_pop" variant="light">REPLIED</Button>
                                                                </Col>
                                                            </Row>
