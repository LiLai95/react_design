        ...
        return (
            <Aux>
                <div className="mt-5 text-center">
                    ...
                    <button className="btn_drip pl-5 pr-5 pt-1 pb-1"><NavLink to='/Campaign/TextCampaign/BlastCampaign/Wireframe'>STATUS DRIP</NavLink></button><br></br>
                    <button className="btn_drip mt-3 pl-5 pr-5 pt-1 pb-1"><NavLink to={'/Campaign/TextCampaign/DripEmailCampaign/Wireframe'}>DRIP</NavLink></button><br></br>
                    <button className="btn_blast_selected mt-3 pl-5 pr-5 pt-1 pb-1"><NavLink to='/Campaign/TextCampaign/BlastCampaign/Wireframe'>BLAST</NavLink></button>    
                </div>
