                                        ...
                                        <div>
                                            <ButtonToolbar>
                                                {[ 'right'].map(placement => (
                                                    ...
                                                    >
                                                    <Button className="btn_circle pl-5 pr-5" variant="light">DELAY<br></br>7 DAYS<br></br>7 HOURS<br></br>55 MIN</Button>
                                                    </OverlayTrigger>
                                                ))}
                                            </ButtonToolbar>
                                        </div>
                                    </Row>
                                    <div style={{height:'5rem',width:'100%'}} className="ml-2">
                                        <Col style={{borderRightStyle:'solid', borderRightColor:'black', borderRightWidth:'1px', height:'100%'}} sm={6} md={6} lg={6}></Col>
                                    </div>
                                    <div className="ml-2">
                                        <ButtonToolbar>
