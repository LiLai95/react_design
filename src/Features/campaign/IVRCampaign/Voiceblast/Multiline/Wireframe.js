...
import wireframe from './../../../../../assets/images/wireframe/Inbound IVR Creation/Multiline Option/multiline Wireframe.png';
    ...
    render() {
        ...
        return (
            <Aux>
                <div className="mt-5">
                    ...
                    <Row>
                        <Col lg={6} className="mt-3">
                            <button className="btn_delay pt-2 pb-2 mt-3 ml-4" onClick={() => this.setState({ isVarying: true, title: '@bootstrap' })}>OUTGOING IVR</button>
                            <button className="btn_delay pt-2 pb-2 mt-3 ml-3" onClick={() => this.setState({ isSecond: true, title: '@bootstrap' })}>INBOUND IVR</button>
                        </Col>
                        <Col lg={6} className="mt-3">
                ...
                <div className="mt-3 ml-4 pb-3" style={{height:'810px', background: '#e3e3e3'}}>
                    <Row className="w-100">
                        <Col sm={1} md={1} lg={2}>
                        </Col>
                ...
                <div>
                            ...
                            <Modal size={"lg"} show={this.state.isVarying} onHide={() => this.setState({ isVarying: false })}>
                                <Modal.Body>
                                        ...
                                        <Row className="mt-3">
                                            <Col sm={12} md={12} lg={8}>
                                                <div className="flex-row">
                                                    <label className="ml-3 pt-2">ASSOCIATE NUMBER TO VENDOR CAMPAIGN?</label>
                                    ...
                                    <Row className="mt-2">
                                        <Col sm={12} md={12} lg={6}>
                                            <div className="ml-5">
                                                <Slider className="pc-range-slider triangle-handler" defaultValue={20} handle={handle} trackStyle={[{ backgroundColor: '#000000' }]} handleStyle={[{ borderBottomColor: '#000' }]} />
                                            </div>
                                    ...
                                    <Row className="pl-5">
                                         ...
                                         <img src={add} width={'5%'} className="ml-2"></img>
                                    </Row>
                    ...
                    <Row>
                        <Col sm={12}>
                            <Modal size={"lg"} show={this.state.isSecond} onHide={() => this.setState({ isSecond: false })}>
                                <Modal.Body>
                                    <div className="text-center">
                                        <h3>MULTI IVR SETTING</h3>
                                    </div>
                                    ...
                                    <div className="mt-3 text-center">
                                        <button className="btn_cancel p-2 text-white" onClick={() => this.setState({ isSecond: false })}>CANCEL</button>
                                        <button className="btn_save ml-2 pl-3 pr-3 pt-2 pb-2 text-white">SAVE</button>
                                    </div>
                                </Modal.Body>
