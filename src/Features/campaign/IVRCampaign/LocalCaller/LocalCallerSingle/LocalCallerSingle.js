        ...
        return (
            <Aux>
                <div className="mt-5 text-center">
                    ...
                    <button className="btn_single_line_selected pl-2 pr-2 pt-1 pb-1"><NavLink to={'/Campaign/IVRCampaign/InboundIVR/LocalCaller/LocalSingleWireframe'}>SINGLE LINE IVR ACTION</NavLink></button><br></br>
                    <button className="btn_multi_line mt-3 pt-1 pb-1 pl-2 pr-2"><NavLink to={'/Campaign/IVRCampaign/InboundIVR/LocalCaller/LocalMultiWireframe'}>MULTILINE IVR ACTION</NavLink></button><br></br>
                </div>
